    ...
    <div class="space-y-6">
        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="space-y-1">
                    <span class="block text-lg font-semibold text-gray-700">Total Successful Withdrawals</span>
                    <div class="py-3 px-6 bg-blue-700 text-white font-bold rounded-lg w-fit">
                        {{ formatCurrency(totalSuccessWithdrawals) }}
                    </div>
                ...
                <form @submit="handleSubmit"
                    ...
                    <div>
                        ...
                        <input id="amount" v-model="form.amount" type="number" step="1000" min="100000" max="9999999999"
                            :disabled="loading"
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            Minimum: {{ formatCurrency(100000) }} | Maximum: {{ formatCurrency(9999999999) }}
                        </p>
                    </div>
