      ...
      <table class="min-w-full table-fixed text-sm text-gray-800">
        <thead>
          <tr class="bg-blue-800 text-white text-left">
            ...
            <th class="px-4 py-3 font-semibold whitespace-nowrap w-48">Date & Time</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3">
              <div class="text-sm">
                <div class="font-medium">{{ formatDate(transaction.date).split(' ').slice(0, 3).join(' ') }}</div>
                <div class="text-xs text-gray-500">{{ formatDate(transaction.date).split(' ').slice(3).join(' ') }}</div>
              </div>
            </td>
            <td class="px-4 py-3">
              <div>
